    ...
    <>
      ...
      <section className="bg-brand-navy pt-32 pb-24 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 30% 60%, #C9A84C 0%, transparent 55%)",
          }}
        />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {/* Coaching */}
            <div className="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition-shadow hover:border-brand-gold/20">
      ...
      <section className="py-24 bg-brand-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Connector line */}
            <div className="hidden lg:block absolute top-8 left-1/4 right-1/4 h-px bg-brand-gold/30 z-0" style={{ left: '12.5%', right: '12.5%' }} />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              {process.map((step) => {
                const Icon = step.icon;
                return (
                  <div key={step.number} className="text-center">
                    <div className="w-16 h-16 rounded-full bg-brand-navy flex items-center justify-center mx-auto mb-5 shadow-lg">
                    ...
                    <h3 className="font-serif text-lg font-bold text-brand-navy mt-2 mb-3">
                      {step.title}
                    </h3>
